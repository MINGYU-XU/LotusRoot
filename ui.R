            ...
            fluidRow(
              ...
              box(width = 12,status = "primary",collapsible = FALSE,solidHeader = TRUE,
                  ...
                  box(
                    ...
                    textInput('projPath', 'Path:', placeholder = 'Where the project stored on the server/URL'),
                    textInput('projSampleSheet', 'Sample Sheet:', placeholder = 'Path/URL where the sample sheet stored'),
                  ...
                  box(
                    ...
                    #            choices = am_researcher[,1]
                    #            ),
                    uiOutput("proj_bioinfo"),
                    #selectInput('projBioinformatician', 'Bioinformatician:', 
                    #            choices = am_bioinformatician[,1]
                    #            ),
                    uiOutput("proj_group"),
                    #selectInput('projGroup', 'Group:', ######!!!
                    #            choices = am_group[,1]
                    #            ),
                    textInput('projdataRepository', 'Data Repository:', placeholder = 'GEO number (eg. GEO10000)'),
